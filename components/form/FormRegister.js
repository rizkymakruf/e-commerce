      ...
      <form onSubmit={onSubmit}>
        <div className="w-full h-full select-none">
          <div className="w-full h-full p-6 bg-white/80 rounded-md shadow-xl">
            <div className="pb-4">
              <p className="text-2xl font-bold">Daftar Sekarang</p>
            </div>

            <div className="w-full h-auto relative mb-4 flex gap-x-2">
              <input
                name="username"
                type="text"
                className="placeholder-gray-300 form-input rounded-md border w-full h-full"
                placeholder="Nomor Handphone Anda"
                disabled={globalCtx.isFetch ? "disabled" : ""}
              />
              <button
                onClick={() => router.push("/auth/", "/auth/")}
                className="px-2 bg-red-600 hover:bg-red-700 rounded-md text-white "
              >
                Daftar
              </button>
              ...
              {/* <button
                onClick={() => router.push("/auth/", "/auth/")}
                // disabled={globalCtx.isFetch ? "disabled" : ""}
                className="px-3 bg-red-600 overflow-hidden text-white rounded-md hover:bg-red-700 items-center flex"
              >
                Daftar
              </button> */}
            </div>
            ...
            <div className="flex flex-col gap-y-6">
              ...
              <div className="flex flex-col items-center gap-y-2">
                <p className="text-xs">Atau daftar dengan</p>
