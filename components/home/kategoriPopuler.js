export default function KategoriPopuler() {
    return(
        ...
        <div className="flex lg:mx-[58px] md:mx-[58px] justify-between mb-1 lg:mb-[24px] lg:text-md ml-3.5">
            <div className="font-bold text-black mt-5 lg:mt-10 mb-1 lg:mb-[24px] text-md lg:text-lg">Kategori Populer</div>
            <a className="" href="#">
        ...
        {/* Content */}
         <div className="flex md:grid md:grid-cols-3 gap-2 md:gap-4 md:mx-[58px] md:overflow-hidden overflow-x-scroll ml-3.5 mb-10">

            <div className="w-52 md:w-full flex-none justify-center items-center">
                <img className="w-full rounded-tr-md rounded-tl-md" src="/static/images/populer1.png"/>
            ...
            <div className="w-52 md:w-full flex-none justify-center items-center">
                <img className="w-full rounded-tr-md rounded-tl-md" src="/static/images/populer2.png"/>
                <div className="bg-[#D63031] text-white items-center text-center justify-center h-11 flex text-[10px] lg:text-[12px] rounded-br-md font-semibold rounded-bl-md">
                    Coffee Grinder
                </div>
            </div>
            <div className="w-52 md:w-full flex-none justify-center items-center mr-3.5">
                <img className="w-full rounded-tr-md rounded-tl-md" src="/static/images/populer3.png"/>
                <div className="bg-[#D63031] text-white items-center text-center justify-center h-11 flex text-[10px] lg:text-[12px] rounded-br-md font-semibold rounded-bl-md">
                    Coffee Machines
                </div>
            </div>
