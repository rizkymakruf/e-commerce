...
const RekomendasiBuatKamu = () => {
  return (
    <div className="py-5">
      <div className="flex pt-3 pb-5 py-2 justify-between">
        <div className="font-bold">Rekomendasi Buat Kamu</div>
        <div>
...
export default RekomendasiBuatKamu;
