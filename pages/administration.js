            ...
            <div className="w-full h-32 relative select-none ">
              <div className="w-full h-full p-3 backdrop-blur bg-white/30 rounded-md border overflow-hidden">
                ...
                <div className="w-full h-full relative flex justify-between items-center gap-3">
                  ...
                  <button onClick={() => logout()} className="w-full h-auto bg-red-50 py-2 overflow-hidden rounded border-2 border-white shadow-lg">
                    Logout
                  </button>
                </div>
              </div>
          ...
          :
            <FormLogin
              ...
              onSubmit={async function handleSubmit(e) {
                ...
                try {
                  await fetchJson("/api/post", {method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body)})
